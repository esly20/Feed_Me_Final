...
class MyMealsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // VC instantialiation
        let storyboard = UIStoryboard(name: "MyMealsList", bundle: nil)
